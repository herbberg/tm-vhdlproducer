...
def gtlPkgGenerator(self, scales, directory):
    ...
    gtl_pkg_param = {
        ...
        'mu_qual_bits': gtl_const['MUON_QUAL_BITS'],
        'mu_iso_bits': gtl_const['MUON_ISO_BITS'],
        ...
        'muon_obj_musoot0': gtl_const['MUON_OBJ_MUSOOT0'],
        'muon_obj_musoot1': gtl_const['MUON_OBJ_MUSOOT1'],
        'eg_et_bits': scales['EG-ET'].getNbits(),
        'eg_eta_bits': scales['EG-ETA'].getNbits(),
        'eg_phi_bits': scales['EG-PHI'].getNbits(),
        'eg_iso_bits': gtl_const['EG_ISO_BITS'],
        ...
        'tau_iso_bits': gtl_const['TAU_ISO_BITS'],
        ...
        'asymet_low': gtl_const['ASYMET_LOW'],
        'asymht_low': gtl_const['ASYMHT_LOW'],
        'asymethf_low': gtl_const['ASYMETHF_LOW'],
        'asymhthf_low': gtl_const['ASYMHTHF_LOW'],
        ...
        'towercount_low': gtl_const['TOWERCOUNT_COUNT_LOW'],
        'towercount_bits': scales['TOWERCOUNT-COUNT'].getNbits(),
        'mb_in_low': gtl_const['MBX_IN_Y_LOW'],
        'mbt0hfp_low': gtl_const['MBT0HFP_COUNT_LOW'],
        'mbt0hfm_low': gtl_const['MBT0HFM_COUNT_LOW'],
        'mbt1hfp_low': gtl_const['MBT1HFP_COUNT_LOW'],
        'mbt1hfm_low': gtl_const['MBT1HFM_COUNT_LOW'],
        ...
        'cent_in_etmhf_low': gtl_const['CENT_IN_ETMHF_LOW'],
        'cent_in_etmhf_high': gtl_const['CENT_IN_ETMHF_HIGH'],
        'cent_in_htmhf_low': gtl_const['CENT_IN_HTMHF_LOW'],
        'cent_in_htmhf_high': gtl_const['CENT_IN_HTMHF_HIGH'],
        'cent_lbits_low': gtl_const['CENT_LBITS_LOW'],
        'cent_lbits_high': gtl_const['CENT_LBITS_HIGH'],
        'cent_ubits_low': gtl_const['CENT_UBITS_LOW'],
        'cent_ubits_high': gtl_const['CENT_UBITS_HIGH'],
